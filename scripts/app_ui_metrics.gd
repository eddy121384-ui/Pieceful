...
const DOCK_WIDTH := 488.0
const DOCK_HEIGHT := 64.0
const DOCK_BOTTOM_MARGIN := 18.0
const DOCK_BUTTON_Y := 10.0

const SLOT_SORT_X := 12.0
const SLOT_PREVIEW_X := 64.0
const SLOT_HINT_X := 116.0
const SLOT_LINES_X := 168.0
const SLOT_FIT_X := 228.0
const SLOT_ZOOM_OUT_X := 280.0
const SLOT_ZOOM_LABEL_X := 328.0
const SLOT_ZOOM_IN_X := 380.0
const SLOT_RESHUFFLE_X := 432.0
